...
type Order = { id: string; createdAt: string; paymentMethod: PaymentMethod; customer: { name: string; phone: string; address: string; notes: string; location?: { lat: number; lon: number } }; items: CartItem[]; zoneId: string; deliveryDate: string; deliveryTime: string; total: number; status: string }
